...
#         print(ScreenshotButton.is_active)
    ...
    def RecordStart(self):
        ...
        #FOR USB SAVE:
        filename_videos = "/media/pi/Capstone/CAPSTONE/VIDEOS/Recording_" + str(random.randint(1000,9999)) + ".avi"
    ...
    def RecordStop(self):
        ...
        # os.system("sudo eject /media/pi/Capstone")
    ...
    def TakeScreenshot(self, frame):
        ...
        #FOR USB SAVE:
        filename_images = "/media/pi/Capstone/CAPSTONE/IMAGES/Screenshot_" + str(random.randint(1000,9999)) + ".jpg"
        cv2.imwrite(filename_images, frame)
